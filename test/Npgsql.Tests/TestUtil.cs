...
namespace Npgsql.Tests
{
    public static class TestUtil
    {
        ...
        /// test database.
        /// </summary>
        public const string DefaultConnectionString = "Server=10.1.1.66;Port=15432;Username=gaussdb;Password=SZoscar55#;Database=postgres;Timeout=0;Command Timeout=0";
