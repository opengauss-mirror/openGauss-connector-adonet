...
namespace OpenGauss.Benchmarks
{
    ...
    {
        OpenGaussConnection _conn = default!, _autoPreparingConn = default!;
        static readonly string[] Queries;
        string _query = default!;
        OpenGaussCommand _preparedCmd = default!;
        ...
        public void GlobalSetup()
        {
            ...
            _autoPreparingConn = new OpenGaussConnection(new OpenGaussConnectionStringBuilder(BenchmarkEnvironment.ConnectionString)
            {
                MaxAutoPrepare = 10
            }.ToString());
...
";
            ...
            _preparedCmd = new OpenGaussCommand(_query, _conn);
...
";
        ...
        {
            using (var cmd = new OpenGaussCommand(_query, _conn))
        ...
        {
            using (var cmd = new OpenGaussCommand(_query, _autoPreparingConn))
                return cmd.ExecuteScalar()!;
        }
