...
namespace OpenGauss.Tests.Replication
{
        ...
        where TConnection : ReplicationConnection, new()
    {
        ...
        private protected async Task<TConnection> OpenReplicationConnectionAsync(OpenGaussConnectionStringBuilder? csb = null, CancellationToken cancellationToken = default)
        {
