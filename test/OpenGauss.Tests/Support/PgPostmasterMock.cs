...
namespace OpenGauss.Tests.Support
{
    class PgPostmasterMock : IAsyncDisposable
    {
            ...
            string? startupErrorCode = null)
        {
            ...
            var connectionStringBuilder = new OpenGaussConnectionStringBuilder(connectionString);
        ...
        async Task<ServerOrCancellationRequest> Accept(bool completeCancellationImmediately)
        {
            ...
            var readBuffer = new OpenGaussReadBuffer(null!, stream, clientSocket, ReadBufferSize, Encoding,
                RelaxedEncoding);
            var writeBuffer = new OpenGaussWriteBuffer(null!, stream, clientSocket, WriteBufferSize, Encoding);
