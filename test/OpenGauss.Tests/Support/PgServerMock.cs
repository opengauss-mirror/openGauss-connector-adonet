...
using TransactionStatus = OpenGauss.NET.Internal.TransactionStatus;
...
namespace OpenGauss.Tests.Support
{
    class PgServerMock : IDisposable
    {
        ...
        internal OpenGaussReadBuffer ReadBuffer => _readBuffer;
        internal OpenGaussWriteBuffer WriteBuffer => _writeBuffer;

        internal PgServerMock(
            NetworkStream stream,
            OpenGaussReadBuffer readBuffer,
            OpenGaussWriteBuffer writeBuffer,
            int processId)
        {
            ProcessId = processId;
            _stream = stream;
