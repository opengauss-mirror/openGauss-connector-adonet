...
namespace OpenGauss.Tests.Types
{
    ...
    {
        OpenGaussConnection OpenAndMapComposite<T>(T composite, string? schema, string nameSuffix, out string nameQualified)
            where T : IComposite
        {
            var nameTranslator = new OpenGaussSnakeCaseNameTranslator();
