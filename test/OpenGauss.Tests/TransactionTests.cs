...
namespace OpenGauss.Tests
{
    public class TransactionTests : MultiplexingTestBase
    {
        ...
        public async Task Commit([Values(PrepareOrNot.NotPrepared, PrepareOrNot.Prepared)] PrepareOrNot prepare)
        {
            ...
            await using (tx)
            {
                var cmd = new OpenGaussCommand($"INSERT INTO {table} (name) VALUES ('X')", conn, tx);
        ...
        [IssueLink("https://github.com/opengauss/opengauss/issues/559")]
        ...
        public async Task Rollback_failed_transaction_with_timeout()
        {
            ...
            var tx = conn.BeginTransaction();
            using var cmd = new OpenGaussCommand("BAD QUERY", conn, tx);
        ...
        [IssueLink("https://github.com/opengauss/opengauss/issues/363")]
        [IssueLink("https://github.com/opengauss/opengauss/issues/184")]
        public async Task Failed_transaction_cannot_rollback_to_savepoint_with_custom_timeout()
        {
            ...
            using var cmd = new OpenGaussCommand("SELECT unknown_thing", conn);
            cmd.CommandTimeout = 1;
            try
            {
                cmd.ExecuteScalar();
        ...
        [IssueLink("https://github.com/opengauss/opengauss/issues/719")]
        public async Task Failed_transaction_on_close_with_custom_timeout()
        {
            ...
            using (var badCmd = new OpenGaussCommand("SEL", conn))
            {
                badCmd.CommandTimeout = OpenGaussCommand.DefaultTimeout + 1;
        ...
        [Test, IssueLink("https://github.com/opengauss/opengauss/issues/555")]
        public async Task Transaction_on_recycled_connection()
        {
            ...
            await using var conn = new OpenGaussConnection(ConnectionString + $";Application Name={GetUniqueIdentifier(nameof(Transaction_on_recycled_connection))}");
            conn.Open();
        ...
        [IssueLink("https://github.com/opengauss/opengauss/issues/985")]
        ...
        public async Task Transaction_not_supported()
        {
            ...
            OpenGaussDatabaseInfo.RegisterFactory(new NoTransactionDatabaseInfoFactory());
            try
            {
                using var conn = await OpenConnectionAsync(connString);
                using var tx = conn.BeginTransaction();
            ...
            {
                OpenGaussDatabaseInfo.ResetFactories();
            }
        ...
        [Test]
        [IssueLink("https://github.com/opengauss/opengauss/issues/3248")]
        // More at #3254
        ...
        [Test]
        [IssueLink("https://github.com/opengauss/opengauss/issues/3306")]
        [TestCase(true)]
        [TestCase(false)]
        ...
        [Test, IssueLink("https://github.com/opengauss/efcore.pg/issues/1593")]
        ...
        [Test, IssueLink("https://github.com/opengauss/opengauss/issues/3686")]
        ...
        class NoTransactionDatabaseInfoFactory : IOpenGaussDatabaseInfoFactory
        {
            public async Task<OpenGaussDatabaseInfo?> Load(OpenGaussConnector conn, OpenGaussTimeout timeout, bool async)
            {
        ...
        class NoTransactionDatabaseInfo : PostgresDatabaseInfo
        {
            ...
            internal NoTransactionDatabaseInfo(OpenGaussConnector conn) : base(conn) {}
        }
        ...
        public void Bug184_Rollback_fails_on_aborted_transaction()
        {
            ...
            using var connTimeoutChanged = new OpenGaussConnection(csb.ToString());
            connTimeoutChanged.Open();
            using var t = connTimeoutChanged.BeginTransaction();
            try {
                var command = new OpenGaussCommand("select count(*) from dta", connTimeoutChanged, t);
