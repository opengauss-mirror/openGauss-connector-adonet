...
namespace OpenGauss.PluginTests
{
    public class NetTopologySuiteTests : TestBase
    {
        ...
        {
            using var conn = OpenConnection(handleOrdinates: Ordinates.XY);
            using var cmd = new OpenGaussCommand("SELECT st_makepoint(1,1)", conn);
        ...
        protected OpenGaussConnection OpenConnection(string? connectionString = null, Ordinates handleOrdinates = Ordinates.None)
        {
