...
using OpenGauss.NetTopologySuite.Internal;
...
{
    /// <summary>
    /// Extension allowing adding the NetTopologySuite plugin to an OpenGauss type mapper.
    /// </summary>
    public static class OpenGaussNetTopologySuiteExtensions
    {
        /// <summary>
        ...
        public static IOpenGaussTypeMapper UseNetTopologySuite(
