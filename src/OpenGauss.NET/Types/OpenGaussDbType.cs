...
namespace OpenGauss.NET.Types
{
    ...
    /// Used in places such as <see cref="OpenGaussParameter.OpenGaussDbType"/> to unambiguously specify
    /// how to encode or decode values.
    /// </summary>
    /// <remarks>See https://www.postgresql.org/docs/current/static/datatype.html</remarks>
    public enum OpenGaussDbType
    {
        ...
        /// another type. This value must be combined with another value from <see cref="OpenGaussDbType"/>
        /// via a bit OR (e.g. OpenGaussDbType.Array | OpenGaussDbType.Integer)
        /// </summary>
        ...
        /// This value must be combined with another value from <see cref="OpenGaussDbType"/>
        /// via a bit OR (e.g. OpenGaussDbType.Range | OpenGaussDbType.Integer)
        /// </summary>
        /// <remarks>
        ...
        /// This value must be combined with another value from <see cref="OpenGaussDbType"/>
        /// via a bit OR (e.g. OpenGaussDbType.Multirange | OpenGaussDbType.Integer)
        /// </summary>
        /// <remarks>
