...
namespace OpenGauss.NET.Types
{
    ...
    /// </remarks>
    public readonly struct OpenGaussRange<T> : IEquatable<OpenGaussRange<T>>
    {
        // -----------------------------------------------------------------------------------------------
        ...
        //
        // See:
        //   - https://github.com/opengauss/opengauss/pull/1939#pullrequestreview-121308396
        ...
        /// </summary>
        public static readonly OpenGaussRange<T> Empty = new(default, default, RangeFlags.Empty);
        ...
        /// <summary>
        /// Constructs an <see cref="OpenGaussRange{T}"/> with inclusive and definite bounds.
        /// </summary>
        /// <param name="lowerBound">The lower bound of the range.</param>
        /// <param name="upperBound">The upper bound of the range.</param>
        public OpenGaussRange([AllowNull] T lowerBound, [AllowNull] T upperBound)
            : this(lowerBound, true, false, upperBound, true, false) { }

        /// <summary>
        /// Constructs an <see cref="OpenGaussRange{T}"/> with definite bounds.
        /// </summary>
        /// <param name="lowerBound">The lower bound of the range.</param>
        ...
        /// <summary>
        /// Constructs an <see cref="OpenGaussRange{T}"/>.
        /// </summary>
        /// <param name="lowerBound">The lower bound of the range.</param>
        /// <param name="lowerBoundIsInclusive">True if the lower bound is is part of the range (i.e. inclusive); otherwise, false.</param>
        ...
        internal OpenGaussRange([AllowNull] T lowerBound, [AllowNull] T upperBound, RangeFlags flags) : this()
        {
            // TODO: We need to check if the bounds are implicitly empty. E.g. '(1,1)' or '(0,0]'.
            // See: https://github.com/opengauss/opengauss/issues/1943.
        ...
        static bool IsEmptyRange([AllowNull] T lowerBound, [AllowNull] T upperBound, RangeFlags flags)
        {
            ...
            //
            // See:
            //  - https://github.com/opengauss/opengauss/pull/1939
            //  - https://github.com/opengauss/opengauss/issues/1943
            // ---------------------------------------------------------------------------------
        ...
        /// <summary>
        /// Indicates whether the <see cref="OpenGaussRange{T}"/> on the left is equal to the <see cref="OpenGaussRange{T}"/> on the right.
        /// </summary>
        /// <param name="x">The <see cref="OpenGaussRange{T}"/> on the left.</param>
        /// <param name="y">The <see cref="OpenGaussRange{T}"/> on the right.</param>
        /// <returns>
        /// True if the <see cref="OpenGaussRange{T}"/> on the left is equal to the <see cref="OpenGaussRange{T}"/> on the right; otherwise, false.
        /// </returns>
        public static bool operator ==(OpenGaussRange<T> x, OpenGaussRange<T> y) => x.Equals(y);

        /// <summary>
        /// Indicates whether the <see cref="OpenGaussRange{T}"/> on the left is not equal to the <see cref="OpenGaussRange{T}"/> on the right.
        /// </summary>
        /// <param name="x">The <see cref="OpenGaussRange{T}"/> on the left.</param>
        /// <param name="y">The <see cref="OpenGaussRange{T}"/> on the right.</param>
        /// <returns>
        /// True if the <see cref="OpenGaussRange{T}"/> on the left is not equal to the <see cref="OpenGaussRange{T}"/> on the right; otherwise, false.
        /// </returns>
        public static bool operator !=(OpenGaussRange<T> x, OpenGaussRange<T> y) => !x.Equals(y);

        /// <inheritdoc />
        public override bool Equals(object? o) => o is OpenGaussRange<T> range && Equals(range);

        /// <inheritdoc />
        public bool Equals(OpenGaussRange<T> other)
        {
        ...
        /// <summary>
        /// Parses the well-known text representation of a PostgreSQL range type into a <see cref="OpenGaussRange{T}"/>.
        /// </summary>
        /// <param name="value">A PosgreSQL range type in a well-known text format.</param>
        /// <returns>
        /// The <see cref="OpenGaussRange{T}"/> represented by the <paramref name="value"/>.
        /// </returns>
        ...
        /// See: https://www.postgresql.org/docs/current/static/rangetypes.html
        /// </remarks>
        public static OpenGaussRange<T> Parse(string value)
        {
            if (value is null)
            ...
            return new OpenGaussRange<T>(lower, lowerInclusive, lowerInfinite, upper, upperInclusive, upperInfinite);
        }

        /// <summary>
        /// Represents a type converter for <see cref="OpenGaussRange{T}" />.
        /// </summary>
        public class RangeTypeConverter : TypeConverter
        {
            /// <summary>
            /// Adds a <see cref="TypeConverterAttribute"/> to the closed form <see cref="OpenGaussRange{T}"/>.
            /// </summary>
            public static void Register() =>
                TypeDescriptor.AddAttributes(
                    typeof(OpenGaussRange<T>),
