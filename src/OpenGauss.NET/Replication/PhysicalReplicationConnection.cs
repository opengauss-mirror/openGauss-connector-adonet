...
namespace OpenGauss.NET.Replication
{
    ...
    public sealed class PhysicalReplicationConnection : ReplicationConnection
    {
        ...
        /// <returns>A <see cref="Task{T}"/> representing an <see cref="IAsyncEnumerable{OpenGaussXLogDataMessage}"/> that
        ...
        public IAsyncEnumerable<XLogDataMessage> StartReplication(PhysicalReplicationSlot? slot,
            OpenGaussLogSequenceNumber walLocation,
        ...
        public IAsyncEnumerable<XLogDataMessage> StartReplication(
            OpenGaussLogSequenceNumber walLocation, CancellationToken cancellationToken, uint timeline = default)
