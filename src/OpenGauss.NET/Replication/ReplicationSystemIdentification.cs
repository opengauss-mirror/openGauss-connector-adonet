...
namespace OpenGauss.NET.Replication
{
    ...
    {
        internal ReplicationSystemIdentification(string systemId, uint timeline, OpenGaussLogSequenceNumber xLogPos, string dbName)
        {
            SystemId = systemId;
            Timeline = timeline;
            XLogPos = xLogPos;
        ...
        /// </summary>
        public OpenGaussLogSequenceNumber XLogPos { get; }
