...
namespace OpenGauss.NET.Replication
{
    ...
    public readonly struct ReplicationSlotOptions
    {
        ...
        public ReplicationSlotOptions(string slotName, string? consistentPoint = null)
            : this(slotName, consistentPoint is null ? default : OpenGaussLogSequenceNumber.Parse(consistentPoint), null){}
        ...
        /// The WAL location at which the slot became consistent.
        /// </param>
        public ReplicationSlotOptions(string slotName, OpenGaussLogSequenceNumber consistentPoint)
            : this(slotName, consistentPoint, null) {}

        internal ReplicationSlotOptions(
            string slotName,
            OpenGaussLogSequenceNumber consistentPoint,
            string? snapshotName)
        {
        ...
        /// The WAL location at which the slot became consistent.
        /// </summary>
        public OpenGaussLogSequenceNumber ConsistentPoint { get; }
