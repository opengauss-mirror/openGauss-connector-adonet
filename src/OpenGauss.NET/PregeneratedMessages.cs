...
#pragma warning disable CS8625
            ...
            using var buf = new OpenGaussWriteBuffer(null, new MemoryStream(), null, OpenGaussWriteBuffer.MinimumSize, Encoding.ASCII);
#pragma warning restore CS8625
        ...
        internal static byte[] Generate(OpenGaussWriteBuffer buf, string query)
        {
