...
namespace OpenGauss.NET
{
    ...
    public sealed class PostgresNotice
    {
        ...
        internal static PostgresNotice Load(OpenGaussReadBuffer buf, bool includeDetail)
    ...
    /// </summary>
    public sealed class OpenGaussNoticeEventArgs : EventArgs
    {
        /// <summary>
        ...
        internal OpenGaussNoticeEventArgs(PostgresNotice notice)
        {
            Notice = notice;
        }
    }
