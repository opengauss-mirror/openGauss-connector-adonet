...
namespace OpenGauss.NET.Schema
{
    ...
    /// </remarks>
    public class OpenGaussDbColumn : DbColumn
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OpenGaussDbColumn" /> class.
        /// </summary>
        public OpenGaussDbColumn()
        {
        ...
        internal OpenGaussDbColumn Clone() =>
            Unsafe.As<OpenGaussDbColumn>(MemberwiseClone());
        ...
        #region OpenGauss-specific fields
        ...
        /// <summary>
        /// The <see cref="OpenGaussDbType" /> value for this column's type.
        /// </summary>
        public OpenGaussDbType? OpenGaussDbType { get; internal set; }
        ...
        public override object? this[string propertyName]
            => propertyName switch
            {
                ...
                nameof(OpenGaussDbType)          => OpenGaussDbType,
                _                             => base[propertyName]
            };

        #endregion OpenGauss-specific fields
    }
}
