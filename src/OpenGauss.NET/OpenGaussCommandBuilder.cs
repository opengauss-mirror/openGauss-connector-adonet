...
namespace OpenGauss.NET
{
    ...
    public sealed class OpenGaussCommandBuilder : DbCommandBuilder
    {
        // Commented out because SetRowUpdatingHandler() is commented, and causes an "is never used" warning
        // private OpenGaussRowUpdatingEventHandler rowUpdatingHandler;

        /// <summary>
        /// Initializes a new instance of the <see cref="OpenGaussCommandBuilder"/> class.
        /// </summary>
        public OpenGaussCommandBuilder()
            : this(null)
        {
        }
        ...
        public OpenGaussCommandBuilder(OpenGaussDataAdapter? adapter)
        {
            DataAdapter = adapter;
            QuotePrefix = "\"";
            QuoteSuffix = "\"";
        ...
        /// It clears the Parameters collection of command. Also, if there is any parameter type which is not supported by OpenGauss, an InvalidOperationException will be thrown.
        ...
        ///</summary>
        /// <param name="command">OpenGaussCommand whose function parameters will be obtained.</param>
        public static void DeriveParameters(OpenGaussCommand command) => command.DeriveParameters();

        /// <summary>
        /// Gets the automatically generated <see cref="OpenGaussCommand"/> object required
        /// to perform insertions at the data source.
        /// </summary>
        /// <returns>
        /// The automatically generated <see cref="OpenGaussCommand"/> object required to perform insertions.
        /// </returns>
        public new OpenGaussCommand GetInsertCommand() => GetInsertCommand(false);

        /// <summary>
        /// Gets the automatically generated <see cref="OpenGaussCommand"/> object required to perform insertions
        ...
        /// The automatically generated <see cref="OpenGaussCommand"/> object required to perform insertions.
        /// </returns>
        public new OpenGaussCommand GetInsertCommand(bool useColumnsForParameterNames)
        {
            var cmd = (OpenGaussCommand) base.GetInsertCommand(useColumnsForParameterNames);
        ...
        /// </returns>
        public new OpenGaussCommand GetUpdateCommand() => GetUpdateCommand(false);

        /// <summary>
        /// Gets the automatically generated <see cref="OpenGaussCommand"/> object required to perform updates
        /// at the data source, optionally using columns for parameter names.
        /// </summary>
        /// <param name="useColumnsForParameterNames">
        /// If <see langword="true"/>, generate parameter names matching column names, if possible.
        ...
        /// </param>
        /// <returns>
        /// The automatically generated <see cref="OpenGaussCommand"/> object required to perform updates.
        /// </returns>
        public new OpenGaussCommand GetUpdateCommand(bool useColumnsForParameterNames)
        {
            var cmd = (OpenGaussCommand)base.GetUpdateCommand(useColumnsForParameterNames);
            cmd.UpdatedRowSource = UpdateRowSource.None;
            return cmd;
        }
        ...
        /// </returns>
        public new OpenGaussCommand GetDeleteCommand() => GetDeleteCommand(false);

        /// <summary>
        /// Gets the automatically generated <see cref="OpenGaussCommand"/> object required to perform deletions
        /// at the data source, optionally using columns for parameter names.
        /// </summary>
        /// <param name="useColumnsForParameterNames">
        /// If <see langword="true"/>, generate parameter names matching column names, if possible.
        ...
        /// </param>
        /// <returns>
        /// The automatically generated <see cref="OpenGaussCommand"/> object required to perform deletions.
        /// </returns>
        public new OpenGaussCommand GetDeleteCommand(bool useColumnsForParameterNames)
        {
            var cmd = (OpenGaussCommand) base.GetDeleteCommand(useColumnsForParameterNames);
            cmd.UpdatedRowSource = UpdateRowSource.None;
            return cmd;
        }
...
/*
        private static void SetParameterValuesFromRow(OpenGaussCommand command, DataRow row)
        {
            foreach (OpenGaussParameter parameter in command.Parameters)
            {
...
*/
        ...
        {
            var param = (OpenGaussParameter)p;
            param.OpenGaussDbType = (OpenGaussDbType)row[SchemaTableColumn.ProviderType];
        }
        ...
        /// <summary>
        /// Registers the <see cref="OpenGaussCommandBuilder" /> to handle the <see cref="OpenGaussDataAdapter.RowUpdating"/> event for a <see cref="OpenGaussDataAdapter" />.
        /// </summary>
        /// <param name="adapter">The <see cref="System.Data.Common.DbDataAdapter" /> to be used for the update.</param>
        protected override void SetRowUpdatingHandler(DbDataAdapter adapter)
        {
            var opengaussAdapter = adapter as OpenGaussDataAdapter;
            if (opengaussAdapter == null)
                throw new ArgumentException("adapter needs to be a OpenGaussDataAdapter", nameof(adapter));

            // Being called twice for the same adapter means unregister
            if (adapter == DataAdapter)
                opengaussAdapter.RowUpdating -= RowUpdatingHandler;
            else
                opengaussAdapter.RowUpdating += RowUpdatingHandler;
        }

        /// <summary>
        /// Adds an event handler for the <see cref="OpenGaussDataAdapter.RowUpdating"/> event.
        /// </summary>
        /// <param name="sender">The sender</param>
        /// <param name="e">A <see cref="OpenGaussRowUpdatingEventArgs"/> instance containing information about the event.</param>
        void RowUpdatingHandler(object sender, OpenGaussRowUpdatingEventArgs e) => base.RowUpdatingHandler(e);
