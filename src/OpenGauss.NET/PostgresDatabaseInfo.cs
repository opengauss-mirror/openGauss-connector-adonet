...
{
    /// <summary>
    /// The default implementation of <see cref="IOpenGaussDatabaseInfoFactory"/>, for standard PostgreSQL databases..
    /// </summary>
    class PostgresDatabaseInfoFactory : IOpenGaussDatabaseInfoFactory
    {
        /// <inheritdoc />
    ...
    /// <summary>
    /// The default implementation of OpenGaussDatabase, for standard PostgreSQL databases.
    /// </summary>
    class PostgresDatabaseInfo : OpenGaussDatabaseInfo
    {
        /// <summary>
        /// The OpenGauss logger instance.
        /// </summary>
        static readonly OpenGaussLogger Log = OpenGaussLogManager.CreateLogger(nameof(PostgresDatabaseInfo));
        ...
        internal PostgresDatabaseInfo(OpenGaussConnector conn)
        ...
        /// </returns>
        internal async Task LoadPostgresInfo(OpenGaussConnector conn, OpenGaussTimeout timeout, bool async)
        {
            HasIntegerDateTimes =
...
ORDER BY oid{(withEnumSortOrder ? ", enumsortorder" : "")};";
        ...
        internal async Task<List<PostgresType>> LoadBackendTypes(OpenGaussConnector conn, OpenGaussTimeout timeout, bool async)
        {
            ...
            static string ReadNonNullableString(OpenGaussReadBuffer buffer)
