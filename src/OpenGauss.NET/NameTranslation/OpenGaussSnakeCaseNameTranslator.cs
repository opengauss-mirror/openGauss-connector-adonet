...
namespace OpenGauss.NET.NameTranslation
{
    /// <summary>
    /// A name translator which converts standard CLR names (e.g. SomeClass) to snake-case database
    /// names (some_class)
    /// </summary>
    public class OpenGaussSnakeCaseNameTranslator : IOpenGaussNameTranslator
    {
        /// <summary>
        /// Creates a new <see cref="OpenGaussSnakeCaseNameTranslator"/>.
        /// </summary>
        public OpenGaussSnakeCaseNameTranslator()
            : this(false) { }
        ...
        /// </param>
        public OpenGaussSnakeCaseNameTranslator(bool legacyMode)
