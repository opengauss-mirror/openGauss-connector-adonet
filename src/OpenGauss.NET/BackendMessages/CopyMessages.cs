...
namespace OpenGauss.NET.BackendMessages
{
    abstract class CopyResponseMessageBase : IBackendMessage
    {
        ...
        internal void Load(OpenGaussReadBuffer buf)
        {
    ...
    class CopyInResponseMessage : CopyResponseMessageBase
    {
        ...
        internal new CopyInResponseMessage Load(OpenGaussReadBuffer buf)
        {
            base.Load(buf);
            return this;
        }
    ...
    class CopyOutResponseMessage : CopyResponseMessageBase
    {
        ...
        internal new CopyOutResponseMessage Load(OpenGaussReadBuffer buf)
        {
            base.Load(buf);
            return this;
        }
    ...
    class CopyBothResponseMessage : CopyResponseMessageBase
    {
        ...
        internal new CopyBothResponseMessage Load(OpenGaussReadBuffer buf)
        {
            base.Load(buf);
            return this;
        }
