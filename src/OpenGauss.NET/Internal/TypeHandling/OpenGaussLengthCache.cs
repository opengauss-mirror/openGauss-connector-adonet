...
namespace OpenGauss.NET.Internal.TypeHandling
{
    ...
    /// </summary>
    public sealed class OpenGaussLengthCache
    {
        public bool IsPopulated;
        public int Position;
        public List<int> Lengths;

        public OpenGaussLengthCache() => Lengths = new List<int>();

        public OpenGaussLengthCache(int capacity) => Lengths = new List<int>(capacity);

        /// <summary>
        /// Stores a length value in the cache, to be fetched later via <see cref="Get"/>.
        /// Called at the <see cref="OpenGaussTypeHandler.ValidateAndGetLength{TAny}"/> phase.
        /// </summary>
