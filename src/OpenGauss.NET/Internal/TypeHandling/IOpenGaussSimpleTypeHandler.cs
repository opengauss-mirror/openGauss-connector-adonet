...
namespace OpenGauss.NET.Internal.TypeHandling
{
    ...
    /// </summary>
    public interface IOpenGaussSimpleTypeHandler<T>
    {
        /// <summary>
        ...
        T Read(OpenGaussReadBuffer buf, int len, FieldDescription? fieldDescription = null);
        ...
        int ValidateAndGetLength([DisallowNull] T value, OpenGaussParameter? parameter);
        ...
        /// information relevant to the write process (e.g. <see cref="OpenGaussParameter.Size"/>).
        /// </param>
        void Write([DisallowNull] T value, OpenGaussWriteBuffer buf, OpenGaussParameter? parameter);
    }
}
