...
namespace OpenGauss.NET.Internal.TypeHandling
{
    ...
    /// <see cref="OpenGaussDateTime"/>). The provider-specific type <typeparamref name="TPsv"/> will be returned
    ...
    public abstract class OpenGaussSimpleTypeHandlerWithPsv<TDefault, TPsv> : OpenGaussSimpleTypeHandler<TDefault>, IOpenGaussSimpleTypeHandler<TPsv>
    {
        public OpenGaussSimpleTypeHandlerWithPsv(PostgresType pgType) : base(pgType) {}
        ...
        protected abstract TPsv ReadPsv(OpenGaussReadBuffer buf, int len, FieldDescription? fieldDescription = null);

        TPsv IOpenGaussSimpleTypeHandler<TPsv>.Read(OpenGaussReadBuffer buf, int len, FieldDescription? fieldDescription)
        ...
        /// in memory (i.e. no I/O is necessary). Called by <see cref="OpenGaussDataReader"/> in non-sequential mode, which
        ...
        public abstract int ValidateAndGetLength(TPsv value, OpenGaussParameter? parameter);
        ...
        /// information relevant to the write process (e.g. <see cref="OpenGaussParameter.Size"/>).
        /// </param>
        public abstract void Write(TPsv value, OpenGaussWriteBuffer buf, OpenGaussParameter? parameter);
