...
namespace OpenGauss.NET.Internal.TypeHandling
{
    ...
    /// </summary>
    public interface IOpenGaussTypeHandler<T>
    {
        /// <summary>
        ...
        ValueTask<T> Read(OpenGaussReadBuffer buf, int len, bool async, FieldDescription? fieldDescription = null);
        ...
        int ValidateAndGetLength([DisallowNull] T value, ref OpenGaussLengthCache? lengthCache, OpenGaussParameter? parameter);
        ...
        /// </param>
        Task Write([DisallowNull] T value, OpenGaussWriteBuffer buf, OpenGaussLengthCache? lengthCache, OpenGaussParameter? parameter, bool async, CancellationToken cancellationToken = default);
    }
}
