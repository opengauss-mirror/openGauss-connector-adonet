...
#pragma warning disable CA1061 // Do not hide base class methods
    public class HstoreHandler :
        OpenGaussTypeHandler<Dictionary<string, string?>>,
        IOpenGaussTypeHandler<IDictionary<string, string?>>
#if !NETSTANDARD2_0 && !NETSTANDARD2_1
        , IOpenGaussTypeHandler<ImmutableDictionary<string, string?>>
#endif
    {
        /// <summary>
        ...
        /// <inheritdoc />
        public int ValidateAndGetLength(IDictionary<string, string?> value, ref OpenGaussLengthCache? lengthCache, OpenGaussParameter? parameter)
        {
        ...
        /// <inheritdoc />
        public override int ValidateAndGetLength(Dictionary<string, string?> value, ref OpenGaussLengthCache? lengthCache, OpenGaussParameter? parameter)
        ...
        public override int ValidateObjectAndGetLength(object? value, ref OpenGaussLengthCache? lengthCache, OpenGaussParameter? parameter)
            ...
            {
#if !NETSTANDARD2_0 && !NETSTANDARD2_1
                ImmutableDictionary<string, string?> converted => ((IOpenGaussTypeHandler<ImmutableDictionary<string, string?>>)this).ValidateAndGetLength(converted, ref lengthCache, parameter),
#endif
                Dictionary<string, string?> converted => ((IOpenGaussTypeHandler<Dictionary<string, string?>>)this).ValidateAndGetLength(converted, ref lengthCache, parameter),
                IDictionary<string, string?> converted => ((IOpenGaussTypeHandler<IDictionary<string, string?>>)this).ValidateAndGetLength(converted, ref lengthCache, parameter),
        ...
        /// <inheritdoc />
        public async Task Write(IDictionary<string, string?> value, OpenGaussWriteBuffer buf, OpenGaussLengthCache? lengthCache, OpenGaussParameter? parameter, bool async, CancellationToken cancellationToken = default)
        {
        ...
        /// <inheritdoc />
        public override Task Write(Dictionary<string, string?> value, OpenGaussWriteBuffer buf, OpenGaussLengthCache? lengthCache, OpenGaussParameter? parameter, bool async, CancellationToken cancellationToken = default)
        ...
        async ValueTask<T> ReadInto<T>(T dictionary, int numElements, OpenGaussReadBuffer buf, bool async)
        ...
        /// <inheritdoc />
        public override async ValueTask<Dictionary<string, string?>> Read(OpenGaussReadBuffer buf, int len, bool async,
        ...
        ValueTask<IDictionary<string, string?>> IOpenGaussTypeHandler<IDictionary<string, string?>>.Read(
        ...
        public int ValidateAndGetLength(
            ImmutableDictionary<string, string?> value, ref OpenGaussLengthCache? lengthCache, OpenGaussParameter? parameter)
        ...
        public Task Write(ImmutableDictionary<string, string?> value,
            OpenGaussWriteBuffer buf, OpenGaussLengthCache? lengthCache, OpenGaussParameter? parameter, bool async, CancellationToken cancellationToken = default)
            => Write((IDictionary<string, string?>)value, buf, lengthCache, parameter, async, cancellationToken);

        async ValueTask<ImmutableDictionary<string, string?>> IOpenGaussTypeHandler<ImmutableDictionary<string, string?>>.Read(
            OpenGaussReadBuffer buf, int len, bool async, FieldDescription? fieldDescription)
        {
            await buf.Ensure(4, async);
            var numElements = buf.ReadInt32();
