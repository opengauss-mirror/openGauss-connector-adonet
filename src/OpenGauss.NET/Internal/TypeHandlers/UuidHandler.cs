...
namespace OpenGauss.NET.Internal.TypeHandlers
{
    ...
    /// </remarks>
    public partial class UuidHandler : OpenGaussSimpleTypeHandler<Guid>
    {
        ...
        /// <inheritdoc />
        public override Guid Read(OpenGaussReadBuffer buf, int len, FieldDescription? fieldDescription = null)
        {
            var raw = new GuidRaw
            {
                Data1 = buf.ReadInt32(),
        ...
        /// <inheritdoc />
        public override int ValidateAndGetLength(Guid value, OpenGaussParameter? parameter)
            => 16;

        /// <inheritdoc />
        public override void Write(Guid value, OpenGaussWriteBuffer buf, OpenGaussParameter? parameter)
        {
