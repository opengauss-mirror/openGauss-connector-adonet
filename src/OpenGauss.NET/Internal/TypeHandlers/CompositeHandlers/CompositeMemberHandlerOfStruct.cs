...
namespace OpenGauss.NET.Internal.TypeHandlers.CompositeHandlers
{
        ...
        where TComposite : struct
    {
        ...
        public CompositeStructMemberHandler(FieldInfo fieldInfo, PostgresType postgresType, OpenGaussTypeHandler handler)
        ...
        public CompositeStructMemberHandler(PropertyInfo propertyInfo, PostgresType postgresType, OpenGaussTypeHandler handler)
        ...
        public override ValueTask Read(TComposite composite, OpenGaussReadBuffer buffer, bool async)
            => throw new NotSupportedException();

        public override async ValueTask Read(ByReference<TComposite> composite, OpenGaussReadBuffer buffer, bool async)
        {
            if (_set == null)
        ...
        public override async Task Write(TComposite composite, OpenGaussWriteBuffer buffer, OpenGaussLengthCache? lengthCache, bool async, CancellationToken cancellationToken = default)
        {
            if (_get == null)
        ...
        public override int ValidateAndGetLength(TComposite composite, ref OpenGaussLengthCache? lengthCache)
        {
            if (_get == null)
                ThrowHelper.ThrowInvalidOperationException_NoPropertyGetter(typeof(TComposite), MemberInfo);
