...
namespace OpenGauss.NET.Internal.TypeHandlers.CompositeHandlers
{
        ...
        where TComposite : class
    {
        ...
        public CompositeClassMemberHandler(FieldInfo fieldInfo, PostgresType postgresType, OpenGaussTypeHandler handler)
        ...
        public CompositeClassMemberHandler(PropertyInfo propertyInfo, PostgresType postgresType, OpenGaussTypeHandler handler)
        ...
        public override async ValueTask Read(TComposite composite, OpenGaussReadBuffer buffer, bool async)
        {
            if (_set == null)
        ...
        public override ValueTask Read(ByReference<TComposite> composite, OpenGaussReadBuffer buffer, bool async)
