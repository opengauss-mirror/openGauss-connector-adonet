...
namespace OpenGauss.NET.Internal.TypeHandlers
{
    ...
    /// </remarks>
    public partial class TextHandler : OpenGaussTypeHandler<string>, IOpenGaussTypeHandler<char[]>, IOpenGaussTypeHandler<ArraySegment<char>>,
        IOpenGaussTypeHandler<char>, IOpenGaussTypeHandler<byte[]>, ITextReaderHandler
    {
        // Text types are handled a bit more efficiently when sent as text than as binary
        // see https://github.com/opengauss/opengauss/issues/1210#issuecomment-235641670
        ...
        /// <inheritdoc />
        public override ValueTask<string> Read(OpenGaussReadBuffer buf, int byteLen, bool async, FieldDescription? fieldDescription = null)
        {
            return buf.ReadBytesLeft >= byteLen
                ? new ValueTask<string>(buf.ReadString(byteLen))
                : ReadLong(buf, byteLen, async);

            static async ValueTask<string> ReadLong(OpenGaussReadBuffer buf, int byteLen, bool async)
            {
                if (byteLen <= buf.Size)
                {
        ...
        async ValueTask<char[]> IOpenGaussTypeHandler<char[]>.Read(OpenGaussReadBuffer buf, int byteLen, bool async, FieldDescription? fieldDescription)
        {
            if (byteLen <= buf.Size)
            {
                // The string's byte representation can fit in our read buffer, read it.
        ...
        async ValueTask<char> IOpenGaussTypeHandler<char>.Read(OpenGaussReadBuffer buf, int len, bool async, FieldDescription? fieldDescription)
        {
            ...
            if (charsUsed < 1)
                throw new OpenGaussException("Could not read char - string was empty");

            return _singleCharArray[0];
        }

        ValueTask<ArraySegment<char>> IOpenGaussTypeHandler<ArraySegment<char>>.Read(OpenGaussReadBuffer buf, int len, bool async, FieldDescription? fieldDescription)
            => throw new NotSupportedException("Only writing ArraySegment<char> to PostgreSQL text is supported, no reading.");

        ValueTask<byte[]> IOpenGaussTypeHandler<byte[]>.Read(OpenGaussReadBuffer buf, int byteLen, bool async, FieldDescription? fieldDescription)
        {
            ...
            static async ValueTask<byte[]> ReadLong(OpenGaussReadBuffer buf, byte[] bytes, int byteLen, bool async)
            {
                if (byteLen <= buf.Size)
                {
        ...
        /// <inheritdoc />
        public override unsafe int ValidateAndGetLength(string value, [NotNullIfNotNull("lengthCache")] ref OpenGaussLengthCache? lengthCache, OpenGaussParameter? parameter)
        {
        ...
        /// <inheritdoc />
        public virtual int ValidateAndGetLength(char[] value, ref OpenGaussLengthCache? lengthCache, OpenGaussParameter? parameter)
        {
            lengthCache ??= new OpenGaussLengthCache(1);
            if (lengthCache.IsPopulated)
                return lengthCache.Get();
        ...
        /// <inheritdoc />
        public virtual int ValidateAndGetLength(ArraySegment<char> value, ref OpenGaussLengthCache? lengthCache, OpenGaussParameter? parameter)
        {
            lengthCache ??= new OpenGaussLengthCache(1);
            if (lengthCache.IsPopulated)
                return lengthCache.Get();
        ...
        /// <inheritdoc />
        public int ValidateAndGetLength(char value, ref OpenGaussLengthCache? lengthCache, OpenGaussParameter? parameter)
        {
        ...
        /// <inheritdoc />
        public override Task Write(string value, OpenGaussWriteBuffer buf, OpenGaussLengthCache? lengthCache, OpenGaussParameter? parameter, bool async, CancellationToken cancellationToken = default)
            => WriteString(value, buf, lengthCache!, parameter, async, cancellationToken);

        /// <inheritdoc />
        public virtual Task Write(char[] value, OpenGaussWriteBuffer buf, OpenGaussLengthCache? lengthCache, OpenGaussParameter? parameter, bool async, CancellationToken cancellationToken = default)
        {
        ...
        /// <inheritdoc />
        public virtual Task Write(ArraySegment<char> value, OpenGaussWriteBuffer buf, OpenGaussLengthCache? lengthCache, OpenGaussParameter? parameter, bool async, CancellationToken cancellationToken = default)
        ...
        Task WriteString(string str, OpenGaussWriteBuffer buf, OpenGaussLengthCache lengthCache, OpenGaussParameter? parameter, bool async, CancellationToken cancellationToken = default)
        {
        ...
        /// <inheritdoc />
        public Task Write(char value, OpenGaussWriteBuffer buf, OpenGaussLengthCache? lengthCache, OpenGaussParameter? parameter, bool async, CancellationToken cancellationToken = default)
        {
            _singleCharArray[0] = value;
