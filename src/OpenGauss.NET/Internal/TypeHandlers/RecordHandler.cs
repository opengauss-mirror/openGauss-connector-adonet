...
namespace OpenGauss.NET.Internal.TypeHandlers
{
    ...
    /// </remarks>
    partial class RecordHandler : OpenGaussTypeHandler<object[]>
    {
        ...
        public override async ValueTask<object[]> Read(OpenGaussReadBuffer buf, int len, bool async, FieldDescription? fieldDescription = null)
        {
        ...
        public override int ValidateAndGetLength(object[] value, ref OpenGaussLengthCache? lengthCache, OpenGaussParameter? parameter)
            => throw new NotSupportedException("Can't write record types");

        public override Task Write(object[] value, OpenGaussWriteBuffer buf, OpenGaussLengthCache? lengthCache, OpenGaussParameter? parameter, bool async, CancellationToken cancellationToken = default)
            => throw new NotSupportedException("Can't write record types");
