...
namespace OpenGauss.NET.Internal.TypeHandlers
{
    ...
    /// </remarks>
    public abstract class ArrayHandler : OpenGaussTypeHandler
    {
        ...
        private protected OpenGaussTypeHandler ElementHandler { get; }
        ...
        /// <inheritdoc />
        protected ArrayHandler(PostgresType arrayPostgresType, OpenGaussTypeHandler elementHandler, ArrayNullabilityMode arrayNullabilityMode, int lowerBound = 1)
        ...
        /// <inheritdoc />
        protected internal override async ValueTask<TRequestedArray> ReadCustom<TRequestedArray>(OpenGaussReadBuffer buf, int len, bool async, FieldDescription? fieldDescription = null)
        {
        ...
        /// </summary>
        protected async ValueTask<Array> ReadArray<TRequestedElement>(OpenGaussReadBuffer buf, bool async, int expectedDimensions = 0, bool readAsObject = false)
        {
        ...
        /// </summary>
        protected async ValueTask<List<TRequestedElement>> ReadList<TRequestedElement>(OpenGaussReadBuffer buf, bool async)
        {
            await buf.Ensure(12, async);
            var dimensions = buf.ReadInt32();
            var containsNulls = buf.ReadInt32() == 1;
        ...
        internal static class ArrayTypeInfo<TArrayOrList>
        {
            ...
            public static readonly Func<ArrayHandler, OpenGaussReadBuffer, bool, ValueTask<Array>> ReadArrayFunc = default!;
            public static readonly Func<ArrayHandler, OpenGaussReadBuffer, bool, ValueTask<TArrayOrList>> ReadListFunc = default!;
            ...
            static ArrayTypeInfo()
            {
                ...
                var bufferParam = Expression.Parameter(typeof(OpenGaussReadBuffer), "buf");
                var asyncParam = Expression.Parameter(typeof(bool), "async");

                if (IsArray)
                {
                    ReadArrayFunc = Expression
                        .Lambda<Func<ArrayHandler, OpenGaussReadBuffer, bool, ValueTask<Array>>>(
                            Expression.Call(
                                arrayHandlerParam,
                ...
                if (IsList)
                {
                    ReadListFunc = Expression
                        .Lambda<Func<ArrayHandler, OpenGaussReadBuffer, bool, ValueTask<TArrayOrList>>>(
                            Expression.Call(
                                arrayHandlerParam,
    ...
    {
        /// <inheritdoc />
        public ArrayHandler(PostgresType arrayPostgresType, OpenGaussTypeHandler elementHandler, ArrayNullabilityMode arrayNullabilityMode, int lowerBound = 1)
        ...
        /// <inheritdoc />
        protected internal override int ValidateAndGetLengthCustom<TAny>([DisallowNull] TAny value, ref OpenGaussLengthCache? lengthCache, OpenGaussParameter? parameter)
        ...
        int ValidateAndGetLength(object value, ref OpenGaussLengthCache? lengthCache)
        {
        ...
        int ValidateAndGetLengthGeneric(ICollection<TElement> value, ref OpenGaussLengthCache lengthCache)
        {
        ...
        int ValidateAndGetLengthNonGeneric(ICollection value, ref OpenGaussLengthCache lengthCache)
        {
            ...
            lengthCache.Set(0);
            OpenGaussLengthCache? elemLengthCache = lengthCache;
        ...
        protected override Task WriteWithLengthCustom<TAny>([DisallowNull] TAny value, OpenGaussWriteBuffer buf, OpenGaussLengthCache? lengthCache, OpenGaussParameter? parameter, bool async, CancellationToken cancellationToken)
        {
        ...
        // The default WriteObjectWithLength casts the type handler to IOpenGaussTypeHandler<T>, but that's not sufficient for
        ...
        async Task WriteGeneric(ICollection<TElement> value, OpenGaussWriteBuffer buf, OpenGaussLengthCache? lengthCache, bool async, CancellationToken cancellationToken = default)
        {
            var len =
                4 +    // dimensions
                4 +    // has_nulls (unused)
        ...
        async Task WriteNonGeneric(ICollection value, OpenGaussWriteBuffer buf, OpenGaussLengthCache? lengthCache, bool async, CancellationToken cancellationToken = default)
        {
    ...
    {
        public ArrayHandlerWithPsv(PostgresType arrayPostgresType, OpenGaussTypeHandler elementHandler, ArrayNullabilityMode arrayNullabilityMode)
        ...
        internal override object ReadPsvAsObject(OpenGaussReadBuffer buf, int len, FieldDescription? fieldDescription = null)
            => ReadPsvAsObject(buf, len, false, fieldDescription).GetAwaiter().GetResult();

        internal override async ValueTask<object> ReadPsvAsObject(OpenGaussReadBuffer buf, int len, bool async, FieldDescription? fieldDescription = null)
