...
namespace OpenGauss.NET.Internal.TypeHandlers
{
    ...
    /// (see discussion https://github.com/opengauss/opengauss/pull/362#issuecomment-59622101).
    ///
    ...
    /// </remarks>
    public partial class BitStringHandler : OpenGaussTypeHandler<BitArray>,
        IOpenGaussTypeHandler<BitVector32>, IOpenGaussTypeHandler<bool>, IOpenGaussTypeHandler<string>
    {
        ...
        /// <inheritdoc />
        public override async ValueTask<BitArray> Read(OpenGaussReadBuffer buf, int len, bool async, FieldDescription? fieldDescription = null)
        {
        ...
        async ValueTask<BitVector32> IOpenGaussTypeHandler<BitVector32>.Read(OpenGaussReadBuffer buf, int len, bool async, FieldDescription? fieldDescription)
        {
            if (len > 4 + 4)
        ...
        async ValueTask<bool> IOpenGaussTypeHandler<bool>.Read(OpenGaussReadBuffer buf, int len, bool async, FieldDescription? fieldDescription)
        {
        ...
        ValueTask<string> IOpenGaussTypeHandler<string>.Read(OpenGaussReadBuffer buf, int len, bool async, FieldDescription? fieldDescription)
        ...
        /// <inheritdoc />
        public override int ValidateAndGetLength(BitArray value, ref OpenGaussLengthCache? lengthCache, OpenGaussParameter? parameter)
            => 4 + (value.Length + 7) / 8;

        /// <inheritdoc />
        public int ValidateAndGetLength(BitVector32 value, ref OpenGaussLengthCache? lengthCache, OpenGaussParameter? parameter)
            => value.Data == 0 ? 4 : 8;

        /// <inheritdoc />
        public int ValidateAndGetLength(bool value, ref OpenGaussLengthCache? lengthCache, OpenGaussParameter? parameter)
            => 5;

        /// <inheritdoc />
        public int ValidateAndGetLength(string value, ref OpenGaussLengthCache? lengthCache, OpenGaussParameter? parameter)
        {
        ...
        /// <inheritdoc />
        public override async Task Write(BitArray value, OpenGaussWriteBuffer buf, OpenGaussLengthCache? lengthCache, OpenGaussParameter? parameter, bool async, CancellationToken cancellationToken = default)
        {
        ...
        /// <inheritdoc />
        public async Task Write(BitVector32 value, OpenGaussWriteBuffer buf, OpenGaussLengthCache? lengthCache, OpenGaussParameter? parameter, bool async, CancellationToken cancellationToken = default)
        {
        ...
        /// <inheritdoc />
        public async Task Write(bool value, OpenGaussWriteBuffer buf, OpenGaussLengthCache? lengthCache, OpenGaussParameter? parameter, bool async, CancellationToken cancellationToken = default)
        {
        ...
        /// <inheritdoc />
        public async Task Write(string value, OpenGaussWriteBuffer buf, OpenGaussLengthCache? lengthCache, OpenGaussParameter? parameter, bool async, CancellationToken cancellationToken = default)
        {
            // Initial bitlength byte
            if (buf.WriteSpaceLeft < 4)
                await buf.Flush(async, cancellationToken);
