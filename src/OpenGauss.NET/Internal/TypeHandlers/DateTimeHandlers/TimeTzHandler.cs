...
namespace OpenGauss.NET.Internal.TypeHandlers.DateTimeHandlers
{
    ...
    /// </remarks>
    public partial class TimeTzHandler : OpenGaussSimpleTypeHandler<DateTimeOffset>
    {
        ...
        /// <inheritdoc />
        public override DateTimeOffset Read(OpenGaussReadBuffer buf, int len, FieldDescription? fieldDescription = null)
        {
        ...
        /// <inheritdoc />
        public override int ValidateAndGetLength(DateTimeOffset value, OpenGaussParameter? parameter) => 12;

        /// <inheritdoc />
        public override void Write(DateTimeOffset value, OpenGaussWriteBuffer buf, OpenGaussParameter? parameter)
        {
