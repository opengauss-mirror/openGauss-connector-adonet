...
namespace OpenGauss.NET.Internal
{
    partial class OpenGaussConnector
    {
        ...
        internal async Task WriteParse(string sql, string statementName, List<OpenGaussParameter> inputParameters, bool async, CancellationToken cancellationToken = default)
        {
        ...
        internal async Task WriteBind(
            List<OpenGaussParameter> parameters,
            string portal,
            string statement,
