...
{
    public sealed partial class OpenGaussReadBuffer
    {
        internal sealed class ColumnStream : Stream
        {
            readonly OpenGaussConnector _connector;
            readonly OpenGaussReadBuffer _buf;
            int _start, _len, _read;
            bool _canSeek;
            bool _startCancellableOperations;
            internal bool IsDisposed { get; private set; }

            internal ColumnStream(OpenGaussConnector connector, bool startCancellableOperations = true)
            {
