...
{
    /// <inheritdoc/>
    public sealed class OpenGaussBatchCommand : DbBatchCommand
    {
        string _commandText;
        ...
        public new OpenGaussParameterCollection Parameters { get; } = new();
        ...
        /// <summary>
        /// The SQL as it will be sent to PostgreSQL, after any rewriting performed by OpenGauss (e.g. named to positional parameter
        /// placeholders).
        /// </summary>
        ...
        /// backing <see cref="OpenGaussCommand.Parameters" /> (in non-batching) mode. If the user provided named parameters, this is a
        /// separate list containing the re-ordered parameters.
        /// </remarks>
        internal List<OpenGaussParameter> PositionalParameters
        {
            get => _inputParameters ??= _ownedInputParameters ??= new();
            set => _inputParameters = value;
        }

        List<OpenGaussParameter>? _ownedInputParameters;
        List<OpenGaussParameter>? _inputParameters;
        ...
        /// <summary>
        /// Initializes a new <see cref="OpenGaussBatchCommand"/>.
        /// </summary>
        public OpenGaussBatchCommand() : this(string.Empty) {}

        /// <summary>
        /// Initializes a new <see cref="OpenGaussBatchCommand"/>.
        /// </summary>
        /// <param name="commandText">The text of the <see cref="OpenGaussBatchCommand"/>.</param>
        public OpenGaussBatchCommand(string commandText)
            => _commandText = commandText;

        internal bool ExplicitPrepare(OpenGaussConnector connector)
        {
            if (!IsPrepared)
            {
        ...
        internal bool TryAutoPrepare(OpenGaussConnector connector)
        {
        ...
        internal void Reset()
        {
            ...
            if (ReferenceEquals(_inputParameters, _ownedInputParameters))
                ...
                _inputParameters = null; // We're pointing at a user's OpenGaussParameterCollection
