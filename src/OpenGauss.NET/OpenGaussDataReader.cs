...
#pragma warning disable CA1010
    public sealed class OpenGaussDataReader : DbDataReader, IDbColumnSchemaGenerator
#pragma warning restore CA1010
    {
        internal OpenGaussCommand Command { get; private set; } = default!;
        ...
        internal OpenGaussReadBuffer Buffer = default!;

        /// <summary>
        /// Holds the list of statements being executed by this reader.
        /// </summary>
        List<OpenGaussBatchCommand> _statements = default!;
        ...
        /// </summary>
        OpenGaussReadBuffer.ColumnStream? _columnStream;
        ...
        internal OpenGaussNestedDataReader? CachedFreeNestedDataReader;

        static readonly OpenGaussLogger Log = OpenGaussLogManager.CreateLogger(nameof(OpenGaussDataReader));

        internal OpenGaussDataReader(OpenGaussConnector connector)
        {
            Connector = connector;
        }

        internal void Init(
            OpenGaussCommand command, CommandBehavior behavior, List<OpenGaussBatchCommand> statements, Task? sendTask = null)
        {
            Command = command;
        ...
        ValueTask<IBackendMessage> ReadMessage(bool async)
        {
            ...
            static async ValueTask<IBackendMessage> ReadMessageSequential(OpenGaussConnector connector, bool async)
            {
                    ...
                    if (RowDescription == null)
                    {
                        ...
                        case BackendMessageCode.CopyInResponse:
                            throw Connector.Break(new NotSupportedException(
                                "COPY isn't supported in regular command execution - see https://www.opengauss.org/doc/copy.html for documentation on COPY with OpenGauss. " +
        ...
        void PopulateOutputParameters()
        {
            ...
            var taken = new List<OpenGaussParameter>();
        ...
        /// a statement-by-statement basis, unlike <see cref="OpenGaussDataReader.RecordsAffected"/>
        /// which exposes an aggregation across all statements.
        /// </remarks>
        [Obsolete("Use the new DbBatch API")]
        public IReadOnlyList<OpenGaussBatchCommand> Statements => _statements.AsReadOnly();
        ...
        public override bool HasRows
            => State switch
            {
                ...
                ReaderState.Disposed => throw new ObjectDisposedException(nameof(OpenGaussDataReader)),
                _ => _hasRows
            };
        ...
        /// <summary>
        /// Releases the resources used by the <see cref="OpenGaussDataReader"/>.
        /// </summary>
        ...
        /// <summary>
        /// Closes the <see cref="OpenGaussDataReader"/> reader, allowing a new command to be executed.
        /// </summary>
            ...
            case ConnectorState.Connecting:
                if (State != ReaderState.Consumed)
                {
                    try
                    {
                        ...
                        ex is OpenGaussException && ex.InnerException is TimeoutException)
                    {
        ...
        internal async Task Cleanup(bool async, bool connectionClosing = false, bool isDisposing = false)
        {
            ...
            OpenGaussEventSource.Log.CommandStop();
        ...
        /// <summary>
        /// Gets the value of the specified column as an <see cref="OpenGaussDate"/>,
        /// OpenGauss's provider-specific type for dates.
        /// </summary>
        /// <remarks>
        ...
        public OpenGaussDate GetDate(int ordinal) => GetFieldValue<OpenGaussDate>(ordinal);
        ...
        /// <summary>
        /// Gets the value of the specified column as an <see cref="OpenGaussTimeSpan"/>,
        /// OpenGauss's provider-specific type for time spans.
        /// </summary>
        /// <remarks>
        /// PostgreSQL's interval type has has a resolution of 1 microsecond and ranges from
        /// -178000000 to 178000000 years, while .NET's TimeSpan has a resolution of 100 nanoseconds
        ...
        [Obsolete(
            ...
            "See https://www.opengauss.org/doc/types/datetime.html for more information.")]
        public OpenGaussTimeSpan GetInterval(int ordinal) => GetFieldValue<OpenGaussTimeSpan>(ordinal);

        /// <summary>
        /// Gets the value of the specified column as an <see cref="OpenGaussDateTime"/>,
        /// OpenGauss's provider-specific type for date/time timestamps. Note that this type covers
        ...
        [Obsolete(
            ...
            "See https://www.opengauss.org/doc/types/datetime.html for more information.")]
        public OpenGaussDateTime GetTimeStamp(int ordinal) => GetFieldValue<OpenGaussDateTime>(ordinal);
        ...
        /// The column type must be a record or a to OpenGauss known composite type, or an array thereof.
        /// Currently only supported in non-sequential mode.
        /// </summary>
        /// <param name="ordinal">The zero-based column ordinal.</param>
        /// <returns>A data reader.</returns>
        public new OpenGaussNestedDataReader GetData(int ordinal)
        {
            ...
            {
                reader = new OpenGaussNestedDataReader(this, null, UniqueRowId, 1, compositeType);
            }
            if (isArray)
                reader.InitArray();
            else
        ...
        ValueTask<Stream> GetStreamInternal(FieldDescription field, int ordinal, bool async, CancellationToken cancellationToken = default)
        {
            ...
            return new ValueTask<Stream>(_columnStream = (OpenGaussReadBuffer.ColumnStream)Buffer.GetStream(ColumnLen, !_isSequential));

            static async Task<Stream> GetStreamLong(OpenGaussDataReader reader, FieldDescription field, Task seekTask, CancellationToken cancellationToken)
            {
                ...
                return reader._columnStream = (OpenGaussReadBuffer.ColumnStream)reader.Buffer.GetStream(reader.ColumnLen, !reader._isSequential);
            }
        }
        ...
        public override int GetProviderSpecificValues(object[] values)
        {
            ...
            if (State != ReaderState.InResult)
            {
                throw State == ReaderState.Disposed
                    ? new ObjectDisposedException(nameof(OpenGaussDataReader))
        ...
        /// </summary>
        /// <returns></returns>
        public ReadOnlyCollection<OpenGaussDbColumn> GetColumnSchema()
        ...
        public new Task<ReadOnlyCollection<OpenGaussDbColumn>> GetColumnSchemaAsync(CancellationToken cancellationToken = default)
#else
        public Task<ReadOnlyCollection<OpenGaussDbColumn>> GetColumnSchemaAsync(CancellationToken cancellationToken = default)
#endif
        {
            using (NoSynchronizationContextScope.Enter())
        ...
        Task<ReadOnlyCollection<OpenGaussDbColumn>> GetColumnSchema(bool async, CancellationToken cancellationToken = default)
            => RowDescription == null || RowDescription.Count == 0
                ? Task.FromResult(new List<OpenGaussDbColumn>().AsReadOnly())
        ...
        async Task<DataTable?> GetSchemaTable(bool async, CancellationToken cancellationToken = default)
        {
            ...
            foreach (var column in await GetColumnSchema(async, cancellationToken))
            {
                ...
                row["ProviderType"] = column.OpenGaussDbType ?? OpenGaussDbType.Unknown;
        ...
        void CheckResultSet()
        {
            ...
            case ReaderState.Disposed:
                throw new ObjectDisposedException(nameof(OpenGaussDataReader));
            default:
                throw new InvalidOperationException("No resultset is currently being traversed");
            }
        }
        ...
        internal void UnbindIfNecessary()
        {
            ...
            if (State != ReaderState.Disposed)
            {
                Connector.DataReader = Connector.UnboundDataReader is { State: ReaderState.Disposed } previousReader
                    ? previousReader
                    : new OpenGaussDataReader(Connector);
