...
namespace OpenGauss.NET
{
    ...
    /// </summary>
    public sealed class OpenGaussLargeObjectStream : Stream
    {
        readonly OpenGaussLargeObjectManager _manager;
        readonly int _fd;
        long _pos;
        readonly bool _writeable;
        bool _disposed;

        internal OpenGaussLargeObjectStream(OpenGaussLargeObjectManager manager, int fd, bool writeable)
        {
            _manager = manager;
            _fd = fd;
            _pos = 0;
