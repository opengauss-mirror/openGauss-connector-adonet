...
namespace OpenGauss.NET
{
    ...
    /// Other errors (e.g. network issues) will be raised via <see cref="OpenGaussException" />,
    /// and purely OpenGauss-related issues which aren't related to the server will be raised
    ...
    /// </remarks>
    [Serializable]
    public sealed class PostgresException : OpenGaussException
    {
        /// <summary>
