...
{
    class JsonbHandler : OpenGauss.NET.Internal.TypeHandlers.JsonHandler
    {
        readonly JsonSerializerSettings _settings;

        public JsonbHandler(PostgresType postgresType, OpenGaussConnector connector, JsonSerializerSettings settings)
